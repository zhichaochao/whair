...
class ModelCatalogReview extends Model {
	public function addReview($data, $path=array()) {
	...
	public function editReview($review_id, $data, $path) {
	...
	* 根据id,删除数据,并删除图片
	* @author  dyl  783973660@qq.com  2016.9.7
	* @param   Int  $review_img_id   id
	*/
	public function deleteReviewImg($review_img_id){
		$sql = "select * from " . DB_PREFIX . "review_img where review_img_id = '".$review_img_id."'";
		$query = $this->db->query($sql);
		$data = $query->row;
		if($data){
		...
		$sql = "delete from " . DB_PREFIX . "review_img where review_img_id = '".$review_img_id."'";
