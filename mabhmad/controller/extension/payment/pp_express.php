...
class ControllerExtensionPaymentPPExpress extends Controller {
	...
	public function index() {
		...
		$data['entry_including_postage'] = $this->language->get('entry_including_postage');
		...
		if (isset($this->request->post['pp_express_is_poundage'])) {
			$data['pp_express_is_poundage'] = $this->request->post['pp_express_is_poundage'];
		} else {
			$data['pp_express_is_poundage'] = $this->config->get('pp_express_is_poundage');
		}

		if (isset($this->request->post['pp_express_including_postage'])) {
			$data['pp_express_including_postage'] = $this->request->post['pp_express_including_postage'];
		} else {
			$data['pp_express_including_postage'] = $this->config->get('pp_express_including_postage');
		}

		if (isset($this->request->post['pp_express_poundage'])) {
			$data['pp_express_poundage'] = $this->request->post['pp_express_poundage'];
		} else {
			$data['pp_express_poundage'] = $this->config->get('pp_express_poundage');
		}
