      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer-group" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-total-order"><?php echo $entry_total_order; ?></label>
            <div class="col-sm-10">
              <input type="text" name="total_order" value="<?php echo $total_order; ?>" placeholder="<?php echo $entry_total_order; ?>" id="input-total-order" class="form-control" />
            </div>
          </div>
          <?php foreach ($languages as $language) { ?>
          <div class="form-group">
