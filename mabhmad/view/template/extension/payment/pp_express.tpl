          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="pp_express_is_poundage" id="input-is-poundage" class="form-control">
                    <?php if ($pp_express_is_poundage) { ?>
                    <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                    <option value="0"><?php echo $text_no; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_yes; ?></option>
              ...
              <!-- start 是否包含商品运费 -->
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-including-postage"><?php echo $entry_including_postage; ?></label>
                <div class="col-sm-10">
                  <select name="pp_express_including_postage" id="input-including-postage" class="form-control">
                    <?php if ($pp_express_including_postage) { ?>
                    <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                    <option value="0"><?php echo $text_no; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_yes; ?></option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="pp_express_poundage" value="<?php echo $pp_express_poundage; ?>" placeholder="<?php echo $entry_poundage; ?>" id="input-poundage" class="form-control" />
                </div>
              </div>
              <!-- end 百分比手续费 -->
              <div class="form-group">
