	   ...
	   <div id="tab-setting<?php echo $i;?>" class="tab-pane">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea cols="100" rows="3" name="xshipping_desc<?php echo $i;?>"><?php echo ${'xshipping_desc'.$i}; ?></textarea>
            </div>
          </div>
            
            <div class="form-group">
              <label class="col-sm-2 control-label"><?php echo $entry_default; ?></label>
              <div class="col-sm-10"><select class="form-control" name="xshipping_default<?php echo $i;?>">
                  <?php if (${'xshipping_default'.$i}) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
