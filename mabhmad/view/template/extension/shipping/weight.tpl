            ...
            <div class="col-sm-10">
              <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-geo-zone<?php echo $geo_zone['geo_zone_id']; ?>">
                  ...
                  <!-- 快递时间说明属性 -->
                  <div class="form-group">
                   <label class="col-sm-2 control-label" for="input-status<?php echo $geo_zone['geo_zone_id']; ?>"><?php echo $entry_shopping_day; ?></label>
                    <div class="col-sm-10">
                      <textarea name="weight_<?php echo $geo_zone['geo_zone_id']; ?>_shopping_day" rows="5" placeholder="<?php echo $entry_shopping_day; ?>" id="input-rate<?php echo $geo_zone['geo_zone_id']; ?>" class="form-control"><?php echo ${'weight_' . $geo_zone['geo_zone_id'] . '_shopping_day'}; ?></textarea>
                    </div>
                  </div>
                  <!-- 快递时间说明属性 -->
                  ...
                  <!-- 添加排序属性 -->
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-rate<?php echo $geo_zone['geo_zone_id']; ?>"><?php echo $entry_sort; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="weight_<?php echo $geo_zone['geo_zone_id']; ?>_sort" value="<?php echo ${'weight_' . $geo_zone['geo_zone_id'] . '_sort'}; ?>" placeholder="<?php echo $entry_sort; ?>" id="input-sort" class="form-control" />
                    </div>
                  </div>
                  <!-- 添加排序属性 -->
