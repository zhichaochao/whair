      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-3">
              ...
              <?php if ($error_date_added) { ?>
                <div class="text-danger"><?php echo $error_date_added; ?></div>
              <?php } ?>
            </div>
          </div>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status">Image</label>           
            <div class="col-sm-10">
              <?php 
			   $index=0;
			   if($review_img){ ?> 
                <?php foreach($review_img as $v){ ?>
					<div>
					<p><img src="<?php echo HTTP_CATALOG.$v['path']; ?>" width="200px" height="200px"/></p>
					<p><input type="button" value="Delete" onclick="deleteImg('<?php echo $v['review_img_id'];?>','<?php echo $v['review_id'];?>')"/></p>
					</div>
                <?php 
				$index++;
				} ?>
