...
class ControllerAccountHelp extends Controller {
	...
	public function index() {
		...
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('account/help', '', true);
			$this->response->redirect($this->url->link('account/login', '', true));
		}

		$this->document->setTitle('Help Center');


		$data['heading_title'] = 'Help Center';
		...
		//feedback提交
		$data['action'] = $this->url->link('account/help');
  ...
  //       foreach ($results as $result) {
		...
		$this->response->setOutput($this->load->view('account/help', $data));
	}
