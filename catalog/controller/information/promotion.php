	...
	public function index() {
		...
		if (isset($this->request->get['path'])) {
			...
			foreach ($parts as $path_id) {
				...
				//$category_info = $this->model_catalog_promotion->getCategory($path_id);
		...
		$category_info = $this->model_catalog_promotion->getCategory($category_id);
		...
		if ($category_info) {
			...
			$data['sort_sort_order'] = $this->url->link('information/promotion', 'token='  . '&sort=p.price' . $url, true);
			$data['sort_sort_order_d'] = $this->url->link('information/promotion', 'token='  . '&sort=p.price&order=DESC' . $url, true);
			$data['sort_sort_add'] = $this->url->link('information/promotion', 'token='  . '&sort=p.date_added' . $url, true);
			$data['sort_sort_rating'] = $this->url->link('information/promotion', 'token='  . '&sort=rating' . $url, true);
			//产品对比按钮
