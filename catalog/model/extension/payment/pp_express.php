...
class ModelExtensionPaymentPPExpress extends Model {
	public function getMethod($address, $total) {
		...
		if ($status) {
			$method_data = array(
				...
				'poundage'   => $poundage,
				'terms'      => '',
				'text'       => $poundage ? $this->currency->format($poundage, $this->session->data['currency']) : false,
	...
	public function addTransaction($transaction_data) {
        ...
        //dyl add
        $transaction_data['parent_id'] = isset($transaction_data['parent_id']) ? $transaction_data['parent_id'] : '';
